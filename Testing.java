...
public class Testing {
    ...
    public void firstTest() {
        AbstractStrategyGame four = new ConnectFour();
        assertEquals(1, four.getNextPlayer(), "Player 1 not next player after construction");
    }

    @Test
    @DisplayName("second Test")
    public void secondTest(){
        AbstractStrategyGame fousr = new ConnectFour();
        assertEquals(1, fousr.getNextPlayer(), "Player 1 not next player after construction");
    ...
    public void thirdTest() {
        AbstractStrategyGame third = new ConnectFour();
        assertEquals(-1, third.getWinner(), "Expected a tie at the beginning of the game");
    }
